...
import { p9FormicaVsHpl } from './content/p9-formica-vs-hpl';
import { p9FormicaVsHplEn } from './content/p9-formica-vs-hpl-en';
...
export function getResources(lang) {
  ...
  const targetSlugs = [
    ...
    'difference-between-formica-and-hpl-phenolic'
  ];
...
export function getProjectGuides(lang) {
  ...
  return pages.filter(page => 
    ...
    !['bathroom-partitions', 'hpl-lockers-ksa', 'shower-cubicles-ksa', 'phenolic-panels-ksa', 'hpl-exterior-cladding-wall-lining-ksa', 'hpl-technical-specifications-submittals-ksa', 'hpl-vs-mdf-comparison-ksa', 'hpl-cleaning-maintenance-guide-ksa', 'difference-between-formica-and-hpl-phenolic'].includes(page.slug)
  );
}
