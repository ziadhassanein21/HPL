...
const industryData = [
  {
    ...
    image: '/Images/hpl-partition-schools-ksa.png',
  ...
  },
  {
    ...
    image: '/Images/hpl-partition-hospitals-ksa.png',
  ...
  },
  {
    ...
    image: '/Images/hpl-mosques-clean.png',
...
function industryPageEn(item) {
  ...
  return {
    ...
    sections: [
      {
        ...
        body: `Facilities in the ${segmentsEn[item.segment] || item.segment} sector face heavy daily use and moisture. Standard materials often fail, leading to frequent maintenance. Our HPL solutions provide the durability and hygiene needed for these environments.`,
      },
      {
        title: 'Proposed Specifications',
        body: 'We recommend specific thicknesses and hardware grades based on the expected traffic and humidity levels of your facility.',
        isSpecsTable: true,
        specsData: [
    ...
    highlights: [
      ...
      '100% Waterproof and impact resistant',
