          ...
          <article className="seo-content-main" style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <div className="seo-content-block">
              ...
              <div style={{ marginTop: '2rem', textAlign: 'center' }}>
                <a href="/ar/hpl-bathroom-partitions-riyadh" className="btn btn-primary">تعرف أكثر على حلول HPL لمشروعك</a>
                <a href="/ar#contact" className="btn btn-secondary" style={{ marginRight: '1rem' }}>تواصل معنا لعرض سعر</a>
              </div>
            </div>
