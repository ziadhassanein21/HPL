      ...
      <div className="container footer-grid">
        <div className="footer-brand-section">
          ...
          <div className="social-links" style={{ display: 'flex', gap: '1.25rem', marginTop: '1.5rem', alignItems: 'center' }}>
            <a href="https://www.tiktok.com/@newbasic..hpl?_r=1&_t=ZS-96BfcLSzgc0" target="_blank" rel="noopener noreferrer" aria-label="TikTok" style={{ color: 'inherit', opacity: 0.8, transition: 'opacity 0.2s', display: 'flex' }} onMouseEnter={(e) => e.currentTarget.style.opacity = 1} onMouseLeave={(e) => e.currentTarget.style.opacity = 0.8}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
                <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
              </svg>
            </a>
            <a href="https://www.instagram.com/newbasic_hpl?igsh=MTZqZmoyNzkxNTJzMg==" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={{ color: 'inherit', opacity: 0.8, transition: 'opacity 0.2s', display: 'flex' }} onMouseEnter={(e) => e.currentTarget.style.opacity = 1} onMouseLeave={(e) => e.currentTarget.style.opacity = 0.8}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
