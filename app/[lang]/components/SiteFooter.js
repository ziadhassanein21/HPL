      ...
      <div className="container footer-grid">
        <div className="footer-brand-section">
          ...
          <div className="social-links" style={{ display: 'flex', gap: '1.25rem', marginTop: '1.5rem', alignItems: 'center' }}>
            ...
            <a href={siteConfig.youtubeUrl || "https://youtube.com/@newbasichpl?si=1h1N6RGUT8GLgN9d"} target="_blank" rel="noopener noreferrer" aria-label="YouTube" style={{ color: 'inherit', opacity: 0.8, transition: 'opacity 0.2s', display: 'flex' }} onMouseEnter={(e) => e.currentTarget.style.opacity = 1} onMouseLeave={(e) => e.currentTarget.style.opacity = 0.8} onClick={() => trackSocial('youtube')}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
